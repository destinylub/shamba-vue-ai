  ...
  return (
    ...
    >
      ...
      <div className="px-10 py-9" style={{ background: C.greenDark }}>
        ...
        <div className="mb-6 grid gap-4" style={{ color: C.cream }}>
          <a
            href="mailto:shambavueai@gmail.com"
            className="flex items-center gap-3 rounded-[10px] px-4 py-3 text-[17px] font-bold underline"
            style={{ background: "rgba(255,253,231,0.12)", border: `2px solid rgba(255,253,231,0.35)` }}
          >
            <span aria-hidden="true" className="text-[20px]">✉️</span>
            <span>shambavueai@gmail.com</span>
          </a>
          <a
            href="https://wa.me/256764028496"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-3 rounded-[10px] px-4 py-3 text-[17px] font-bold underline"
            style={{ background: "rgba(255,253,231,0.12)", border: `2px solid rgba(255,253,231,0.35)` }}
